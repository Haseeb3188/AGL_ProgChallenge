...
describe("CatApp", function () {
  ...
  describe('init', function () {
    it('should be able to get the dom element with id "pets" as the target node', function () {
  ...
  describe('fetchData', function () {
    ...
    it('should be able to call window.fetch function and get data from api', function () {
  ...
  describe('processData', function () {
    it('should list all the Cats, grouped by their owners gender', function () {
    ...
    it('should filter data and group by owner gender type', function () {
  ...
  describe('getCatsSortedByName', function () {
    ...
    it('should sort all cats in alphabetical order', function () {
      const catList = [
        {
          "name": "Garfield",
          "type": "Cat"
